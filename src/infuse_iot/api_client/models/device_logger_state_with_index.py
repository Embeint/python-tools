...
T = TypeVar("T", bound="DeviceLoggerStateWithIndex")


@_attrs_define
class DeviceLoggerStateWithIndex:
    """
    Attributes:
        download_enabled (bool): Whether logger download is enabled
        index (int): Index of logger
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        device_logger_state_with_index = cls(
        ...
        return device_logger_state_with_index
