...
class DefinitionsTDFStructs:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        definitions_tdf_structs.additional_properties = additional_properties
        return definitions_tdf_structs
