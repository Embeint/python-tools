...
class DownlinkRoute:
    ...
    Attributes:
        ...
        udp (UdpDownlinkRoute | Unset):
        bt_adv (BtLeRoute | Unset):
        bt_peripheral (BtLeRoute | Unset):
        bt_central (BtLeRoute | Unset):
        forwarded (ForwardedDownlinkRoute | Unset):
    """

    interface: RouteType
    interface_data: InterfaceData
    udp: UdpDownlinkRoute | Unset = UNSET
    bt_adv: BtLeRoute | Unset = UNSET
    bt_peripheral: BtLeRoute | Unset = UNSET
    bt_central: BtLeRoute | Unset = UNSET
    forwarded: ForwardedDownlinkRoute | Unset = UNSET
