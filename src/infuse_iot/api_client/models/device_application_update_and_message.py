...
T = TypeVar("T", bound="DeviceApplicationUpdateAndMessage")


@_attrs_define
class DeviceApplicationUpdateAndMessage:
    """
    Attributes:
        ...
        downlink_message (DownlinkMessage | Unset):
    """
    ...
    downlink_message: DownlinkMessage | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        downlink_message: dict[str, Any] | Unset = UNSET
        if not isinstance(self.downlink_message, Unset):
        ...
        if downlink_message is not UNSET:
            field_dict["downlinkMessage"] = downlink_message
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        _downlink_message = d.pop("downlinkMessage", UNSET)
        downlink_message: DownlinkMessage | Unset
        if isinstance(_downlink_message, Unset):
            downlink_message = UNSET
        else:
            downlink_message = DownlinkMessage.from_dict(_downlink_message)
        ...
        device_application_update_and_message.additional_properties = d
        return device_application_update_and_message
